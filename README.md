...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? I would say it would be the HTML that provides essential value to the code. 

2. What are the 4 areas of the box model? Margin, padding, content, border

3. While using flexbox, what axis does the following property work on: ```align-items: center```? main axis

4. Explain why git is valuable to a team of developers. Git makes it easy to make branches and compare them in a task. Git also makes it easier to commit and make changes to something. 

5. Define mobile-first design in your own words. It is where the mobile design is considered first and the larger screens build up after the mobile design. 
